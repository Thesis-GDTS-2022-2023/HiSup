...
from . import train_dataset_
from hisup.config.paths_catalog_ import DatasetCatalog
from . import test_dataset_
...
def build_train_dataset(cfg):
    ...
    factory = getattr(train_dataset_, dargs['factory'])
    args = dargs['args']
    ...
    dataset = DataLoader(dataset,
                        ...
                        collate_fn=train_dataset_.collate_fn,
                        shuffle=True,
...
def build_test_dataset(cfg):
    ...
    dargs = DatasetCatalog.get(name)
    factory = getattr(test_dataset_, dargs['factory'])
    args = dargs['args']
